...
public class Podometro {
    ...
    public void registrarCaminata(int pasos, int dia, int horaInicio,
        ...
        tiempo = horaFin - horaInicio + tiempo;
    }
    ...
    public void printConfiguracion() {
        ...
        System.out.println("*********************************");
        System.out.println("Altura: " + altura/100);
    ...
    public void printEstadísticas() {
        ...
        System.out.println ();
        System.out.println ();
        System.out.println ("Tiempo total caminado en la semana: " + (tiempo/100) +"h. y " + (tiempo % 100) + "min.");
