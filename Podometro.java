/**
 * La clase modela un sencillo podómetro que registra información acerca de los
 * pasos, distancia, ..... que una persona ha dado en una semana.
 * 
 * @author Montse&Aitor
 */
public class Podometro {
    ...
    /**
     * Inicializa el podómetro con la marca indicada por el parámetro. El resto de
     * atributos se ponen a 0 y el sexo, por defecto, es mujer
     */
    ...
    /**
     * Simula la configuración del podómetro. Recibe como parámetros la altura y el
     * sexo de una persona y asigna estos valores a los atributos correspondiente.
    ...
    /**
     * Recibe cuatro parámetros que supondremos correctos: pasos - el nº de pasos
     * caminados dia - nº de día de la semana en que se ha hecho la caminata (1 -
     * Lunes, 2 - Martes - .... - 6 - Sábado, 7 - Domingo) horaInicio - hora de
     * inicio de la caminata horaFin - hora de fin de la caminata
     * 
     * A partir de estos parámetros el método debe realizar ciertos cálculos y
     * actualizará el podómetro adecuadamente
     * 
    ...
    /**
     * Muestra en pantalla la configuración del podómetro (altura, sexo y longitud
     * de la zancada)
     * 
     * (ver enunciado)
     * 
    ...
    /**
     * Muestra en pantalla información acerca de la distancia recorrida, pasos,
    ...
    /**
     * Calcula y devuelve un String que representa el nombre del día en el que se ha
     * caminado más pasos - "SÁBADO" "DOMINGO" o "LABORABLES"
     */
    ...
    /**
     * Restablecer los valores iniciales del podómetro Todos los atributos se ponen
     * a cero salvo el sexo que se establece a MUJER. La marca no varía
     * 
     */
    public void reset() {
