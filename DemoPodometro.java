...
public class DemoPodometro {
     ...
     */
    private void registrarCaminatas(int[] pasos, int[] dias, int[] horasInicio, int[] horasFin) {

        for (int i = 0; i < pasos.length; i++) {
            podometro.registrarCaminata(pasos[i], dias[i], horasInicio[i], horasFin[i]);
        }
    ...
    private void mostrarEstadisticas() {
        ...
        System.out.print("Día/s con más pasos caminados: " + podometro.diaMayorNumeroPasos());
